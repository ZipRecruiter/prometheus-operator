...
var DefaultCrdKinds = CrdKinds{
	KindsString:    "",
	Prometheus:     CrdKind{Plural: PrometheusName, Kind: PrometheusesKind, SpecName: "github.com/ZipRecruiter/prometheus-operator/pkg/apis/monitoring/v1.Prometheus"},
	ServiceMonitor: CrdKind{Plural: ServiceMonitorName, Kind: ServiceMonitorsKind, SpecName: "github.com/ZipRecruiter/prometheus-operator/pkg/apis/monitoring/v1.ServiceMonitor"},
	PodMonitor:     CrdKind{Plural: PodMonitorName, Kind: PodMonitorsKind, SpecName: "github.com/ZipRecruiter/prometheus-operator/pkg/apis/monitoring/v1.PodMonitor"},
	Alertmanager:   CrdKind{Plural: AlertmanagerName, Kind: AlertmanagersKind, SpecName: "github.com/ZipRecruiter/prometheus-operator/pkg/apis/monitoring/v1.Alertmanager"},
	PrometheusRule: CrdKind{Plural: PrometheusRuleName, Kind: PrometheusRuleKind, SpecName: "github.com/ZipRecruiter/prometheus-operator/pkg/apis/monitoring/v1.PrometheusRule"},
	ThanosRuler:    CrdKind{Plural: ThanosRulerName, Kind: ThanosRulerKind, SpecName: "github.com/ZipRecruiter/prometheus-operator/pkg/apis/monitoring/v1.ThanosRuler"},
}
